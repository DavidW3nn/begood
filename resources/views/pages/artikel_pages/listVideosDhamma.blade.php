...
@section('content')
    <div class="container" style="margin-top: 110px;">
        <div class="bg-white p-4 rounded shadow-sm mb-4">
            <h1 class="text-center display-7" style="font-weight: bold">@lang('message.daftar_video_dhamma')</h1>
        </div>
                ...
                <div class="col-md-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex mt-5">
                            ...
                            {{-- Detail --}}
                            <a href="/video-detail-dhamma" class="btn btn-dark ms-auto" type="button">@lang('message.detail')</a>
                        </div>
                    </div>
                </div>
